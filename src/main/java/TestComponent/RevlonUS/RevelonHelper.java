package TestComponent.RevlonUS;
...
*/
...

	{
		...
		if (Common.isElementDisplayed("xpath", "//a[contains(text(),'Product Info Request')]")) {
			...
			Common.clickElement("xpath", "//a[contains(text(),'Product Info Request')]");
			Common.actionsKeyPress(Keys.PAGE_DOWN);
			Common.clickElementWithoutWait("xpath", "//a[text()='What is my warranty?']");
		...
		ExtenantReportUtils.addPassLog(expectedResult, "Should dispaly Contact us page with data",
				"Contact Us Page with data displayed successfully",
				Common.getscreenShotPathforReport("Contact Us Page with data"));
...
*/
			...
			String s = Common.findElement("xpath", "//h1[text()='Your question has been submitted!']").getText();
			System.out.println(s);
			...
			Common.assertionCheckwithReport(s.equals("Your question has been submitted!"), "Should dispaly Contact us page with data", expectedResult, "failed to submit Contact Us page");


			ExtenantReportUtils.addPassLog(expectedResult, "Should display Contact_US success Page",
					"Contact_US success Page display successfully",
					Common.getscreenShotPathforReport("Contact US page submit successfull"));
		} catch (Exception | Error e) {
			ExtenantReportUtils.addFailedLog(expectedResult, "Should display Contact_US success Page",
					"Contact_US success Page not displayed",
					Common.getscreenShotPathforReport("Contact_US success Failed"));
			Assert.fail();
			e.printStackTrace();
		}
...
/*
	...
	*/	
		...
		ExtenantReportUtils.addFailedLog("To verify the data population in the product registration form" , "Should populate all the data in the product registration form",
				"data populated in all the fields in the product registration form",
				Common.getscreenShotPathforReport("Product Registration page data population paassed"));

	}catch(Exception | Error e){
		ExtenantReportUtils.addFailedLog("To verify the data population in the product registration form", "Should display Product Registration success Page",
				"Product Registration success Page not displayed",
				Common.getscreenShotPathforReport("Product Registration page data population failed"));
		e.printStackTrace();
		Assert.fail();
	}
	}
	...
	public void ProductRegistration() throws Exception {
		...
		/*	if (Common.isElementEnabled("xpath", "//input[@name='Contact.Name.First']")) {
			...
			String successmessage = Common.findElement(By.xpath("//h1[text()='Thank you for registering your product!  Your request has been processed.']")).getText();

			
			Assert.assertEquals(successmessage,
					"Thank you for registering your product! Your request has been processed.");

			ExtenantReportUtils.addPassLog(expectedResult, "Should display Product Registration success Page",
			...
			ExtenantReportUtils.addFailedLog(expectedResult, "Should display Product Registration success Page",
					"Product Registration success Page not displayed",
...
Common.actionsKeyPress(Keys.PAGE_UP);
	...
	public void ShippingAddress(String dataSet) throws Exception {
		...
		try {
			...
			Thread.sleep(3000);
			ExtenantReportUtils.addPassLog(expectedResult2, "Should dispaly Shipping address page",
					"shipping address Page displayed successfully",
					Common.getscreenShotPathforReport("Shipping address"));
		} catch (Exception | Error e) {
			ExtenantReportUtils.addFailedLog(expectedResult2, "Should display Checkout Page", "Checkout Page not displayed",
					Common.getscreenShotPathforReport("Checkout Failed"));
			e.printStackTrace();
			Assert.fail();
		}
	...
	public void ProductReview(String dataSet) throws Exception {
		...
		try {
			...
			ExtenantReportUtils.addPassLog(expectedResult, "Should update Product Review for selected product",
					"Updated Product review for selected product successfully",
					Common.getscreenShotPathforReport("Product Review success"));
		} catch (Exception | Error e) {
			ExtenantReportUtils.addFailedLog(expectedResult, "Should update Product Review for selected product",
	...
	public void categoryMenuItem() {
		...
		try {
			...
			Thread.sleep(5000);
			ExtenantReportUtils.addPassLog(expectedResult, "Should display item from  menucategory", "product display successfully",
					Common.getscreenShotPathforReport(" product display success"));

		} catch (Exception e) {
			ExtenantReportUtils.addFailedLog(expectedResult, "Should display Search Results Page", "Search results Page not display",
					Common.getscreenShotPathforReport("Search result Failed"));
			e.printStackTrace();
			Assert.fail();
		}
	...
	public void headLinks(String dataSet) throws Exception {
		...
		for (int i = 0; i < headers.length; i++) {
			...
			ExtenantReportUtils.addPassLog(expectedResult, "Should display " + headers[i] + " success Page",
	...
	public void navigateMyAccounts() throws InterruptedException {
		...
		try {
			...
			ExtenantReportUtils.addPassLog(expectedResult, "Should display My Account Page",
					"My Account Page displayed successfully",
					Common.getscreenShotPathforReport("My Account Page success"));
		} catch (Exception | Error e) {
			ExtenantReportUtils.addFailedLog(expectedResult, "Should display My Account Page", "My Account Page not display",
	...
	public void navigateMyorders() throws Exception {
		...
		try {
			...
			ExtenantReportUtils.addPassLog(expectedResult, "Should display My Order page with List of orders",
					"My Order page with List of orders display successfully",
					Common.getscreenShotPathforReport("MyOrder Page success"));
		} catch (Exception | Error e) {
			ExtenantReportUtils.addFailedLog(expectedResult, "Should display My Order page with List of orders",
	...
	public void newsletterSubscription() throws Exception {
		...
		try {
			...
			ExtenantReportUtils.addPassLog(expectedResult, "Should display Email in Newsletter subscription",
					"Email in Newsletter subscription display successfully",
					Common.getscreenShotPathforReport("Newsletter success"));
		} catch (Exception | Error e) {
			ExtenantReportUtils.addFailedLog(expectedResult, "Should display Email in Newsletter subscription",
	...
	public void InstaGramArticle() throws Exception {
		...
		try {
			...
			ExtenantReportUtils.addPassLog(expectedResult, "Should display Instagram page", "Instagram page display successfully",
					Common.getscreenShotPathforReport("Instagram page success"));
		} catch (Exception | Error e) {
			ExtenantReportUtils.addFailedLog(expectedResult, "Should display Instagram page", "Instagram page not displayed",
	...
	public void FacebookArticle() throws Exception {
		...
		try {
			...
			ExtenantReportUtils.addPassLog(expectedResult, "Should display Facebook page", "Facebook page display successfully",
					Common.getscreenShotPathforReport("Facebook page success"));
		} catch (Exception | Error e) {
			ExtenantReportUtils.addFailedLog(expectedResult, "Should display Facebook page", "Facebook page not displayed",
	...
	public void youtubeArticle() throws Exception {
		...
		try {
			...
			ExtenantReportUtils.addPassLog(expectedResult, "Should display Youtube page", "Youtube page display successfully",
					Common.getscreenShotPathforReport("Youtube page success"));
		} catch (Exception | Error e) {
			ExtenantReportUtils.addFailedLog(expectedResult, "Should display Youtube page", "Youtube page not displayed",
	...
	public void pinterestArticle() throws Exception {
		...
		try {
			...
			// Assert.assertEquals(s, "Revlon Hair Tools");
			ExtenantReportUtils.addPassLog(expectedResult, "Should display Pinterest page", "Pinterest page display successfully",
					Common.getscreenShotPathforReport("Pinterest page success"));
		} catch (Exception | Error e) {
			ExtenantReportUtils.addFailedLog(expectedResult, "Should display Pinterest page", "Pinterest page not displayed",
	...
	public void ValidateAddressinformation() throws Exception {
		...
		try {
			...
			ExtenantReportUtils.addPassLog(expectedResult, "Should display Addressinformation page",
					"Addressinformation page display successfully",
					Common.getscreenShotPathforReport("Addressinformation Page success"));
		} catch (Exception | Error e) {
			ExtenantReportUtils.addFailedLog(expectedResult, "Should display Addressinformation page",
	...
	public void ValidateNewsletterSubscription() throws Exception {
		...
		try {
			...
			ExtenantReportUtils.addPassLog(expectedResult, "Should display Newsletter Subscription page",
					"Newsletter Subscription page display successfully",
					Common.getscreenShotPathforReport("Newsletter Subscription Page success"));
		} catch (Exception | Error e) {
			ExtenantReportUtils.addFailedLog(expectedResult, "Should display Newsletter Subscription page",
	...
	if(Common.isElementDisplayed("xpath", "//a[text()='Back in Stock Subscriptions']")){
		try {
...
//			Assert.assertEquals(backtostock, "My Back in Stock Subscriptions");
			...
			ExtenantReportUtils.addPassLog(expectedResult, "Should display Back to stock page",
					"Back to stock page display successfully",
					Common.getscreenShotPathforReport("Back to stock Page success"));
		} catch (Exception | Error e) {
			ExtenantReportUtils.addFailedLog(expectedResult, "Should display Back to stock page", "Back to stock page not displayed",
	...
	public void ValidateQuestion() throws Exception {
		...
		try {
			...
			ExtenantReportUtils.addPassLog(expectedResult, "Should display Question page", "Question page display successfully",
					Common.getscreenShotPathforReport("Question Page success"));
		} catch (Exception | Error e) {
			ExtenantReportUtils.addFailedLog(expectedResult, "Should display Question page", "Question page not displayed",
	...
	public void CreateAccount(String dataSet) throws InterruptedException {
		...
		try {
			Common.clickElement("xpath", "//button[text()='Create an Account']");
			Thread.sleep(3000);
			ExtenantReportUtils.addPassLog(expectedResult, "Should display Account Creation page",
					"Account Creation page display successfully",
					Common.getscreenShotPathforReport("Account Creation"));
			Common.textBoxInput("id", "firstname", data.get(dataSet).get("FirstName").toString());
			Common.textBoxInput("id", "lastname", data.get(dataSet).get("LastName").toString());
			...
			String s = Common.getText("xpath", "//span[contains(text(),'My Account')]");
			Assert.assertEquals(s, "My Account");
			ExtenantReportUtils.addPassLog(expectedResult, "Should display My Account Page", "My Account Page display successfully",
					Common.getscreenShotPathforReport("Account Creation success"));
			// report.addPassLog(expectedResult, "Should display My Account Page", "My
			// Account Page display successfully",
			// Common.getscreenShotPathforReport("Account Creation success"));
	...
	public void ValidateMyAccountAVS(String dataSet) throws Exception {
		...
		try {
			...
			ExtenantReportUtils.addPassLog(expectedResult, "Should dispaly New Address Book page",
					"New Address Book page displayed successfully",
					Common.getscreenShotPathforReport("Address Book Pass"));
		} catch (Exception | Error e) {
			ExtenantReportUtils.addFailedLog(expectedResult, "Should display New Address Book Page",
	...
	public void Newslettersignup(String dataSet) throws Exception {
		...
		try {
			...
			ExtenantReportUtils.addPassLog("subscription for Newsletter in homepage", expectedResult,
					"Newsletter Subscription successfull",
					Common.getscreenShotPathforReport("HomePage Newsletter Subscription passed"));
		} catch (Exception | Error e) {
			ExtenantReportUtils.addFailedLog(expectedResult, "Should Navigating to Subscription Popup in Home Page",
	...
	public void Registerincreaseproductquantity() {
		...
		try {
			...
			ExtenantReportUtils.addPassLog(expectedresult, "order will be delivered for free message should be displayed",
			...
			ExtenantReportUtils.addFailedLog(expectedresult, "amount left for free delivery message will be displayed",
	...
	public void RegisteruseraddNewAddress(String dataSet) {
		try {
			...
			Thread.sleep(3000);
			ExtenantReportUtils.addPassLog("should land on shipping page", "shipping address page will be displayed ",
					Common.getscreenShotPathforReport("shipping address page navigated successfully"));
		} catch (Exception | Error e) {
			ExtenantReportUtils.addFailedLog("failed navigating to shiping address page ",
	...
	public void clickaddnewaddress() {
		...
		try {
			...
			ExtenantReportUtils.addPassLog("Should navigate to shipping address window", "shipping address window will be displayed",
					Common.getscreenShotPathforReport("shipping address window displayed successfully"));

		} catch (Exception | Error e) {
			ExtenantReportUtils.addFailedLog("Should navigate to shipping address window", "shipping address window not displayed",
	...
	public void Twoproductselection() {
		try {
			...
			ExtenantReportUtils.addFailedLog("should add two products to the cart", "products not added to cart",
	...
	public void homepageaddtocart() throws Exception {
		...
		try {
			...
			System.out.println(s);
			Assert.assertEquals(s, "You added Salon One-Step Hair Dryer and Volumizer in Teal to your shopping cart.");
			ExtenantReportUtils.addPassLog(expectedresult, "Added product to cart successfully",
					Common.getscreenShotPathforReport("Successfully added product to cart"));

		} catch (Exception | Error e) {
			ExtenantReportUtils.addFailedLog(expectedresult, "Added product to cart successfully",
	...
	public void BillingaddressoutsideUS() throws Exception {
		try {
			...
			ExtenantReportUtils.addFailedLog("should add new billing address", "Billing address not added ",
					Common.getscreenShotPathforReport("Failed to add billing address"));
			e.printStackTrace();
			Assert.fail();
		}
	...
	public void TaxandShippingAmountvalidation(String dataSet) {
		...
		Common.assertionCheckwithReport(caltaxvalue1.equals(taxamount), "The actual tax and calculated tax are equal ", Expectedresult1, "The calculated tax and actual tax are not equal");
			...
			ExtenantReportUtils.addPassLog(Expectedresult, "Shipping amount and tax will be displayed",
					Common.getscreenShotPathforReport(" Successfully displayed the tax"));

		} catch (Exception | Error e) {
			ExtenantReportUtils.addFailedLog(Expectedresult, "Shipping amount and tax not displayed",
...
*/
			...
			ExtenantReportUtils.addPassLog("To verify the navigation to payments and review page", expectedResult,
					"Checkout Page display successfully", Common.getscreenShotPathforReport("Checkout page success"));

		} catch (Exception | Error e) {

			ExtenantReportUtils.addFailedLog(expectedResult, "Review and payments page dispaly failed",
					Common.getscreenShotPathforReport("Failed to display the tax"));
		...
		//Assert.assertEquals("URL", "https://stg-upgrade.revlonhairtools.com/us_en/checkout/#payment");
	     ...
	     Common.actionsKeyPress(Keys.PAGE_UP);
	      ...
	      Assert.assertEquals(nopayment, "No Payment Information Required");
			...
			ExtenantReportUtils.addFailedLog("Gift card should be applied on the total cart value ", "Should apply the discount code successfully", "Gift card not applied",
