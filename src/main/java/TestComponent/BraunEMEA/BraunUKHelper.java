package TestComponent.BraunEMEA;
...
public class BraunUKHelper {
	...
	public  BraunUKHelper(String datafile)
	{
	...
	public void FranceProductselection() throws Exception
	{
		...
		try {
			...
			Sync.waitElementPresent("xpath", "//a[@title='Braun ThermoScan® 7 avec Age Precision®']");
			Common.clickElement("xpath", "//a[@title='Braun ThermoScan® 7 avec Age Precision®']");
			Thread.sleep(2000);
...
catch(Exception |Error e)
{
	...
	public void CreditcardPayment(String dataSet) throws Exception
	{
		...
		try {
			...
			//Common.clickElement(By.xpath("//input[@id='shipping-save-in-address-book']]"));
