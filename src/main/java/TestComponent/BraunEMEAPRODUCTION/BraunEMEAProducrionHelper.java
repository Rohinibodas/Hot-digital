...
public class BraunEMEAProducrionHelper {
	...
	public void PolandNewslettersubscription(String dataset) throws Exception
	{
		...
		try {
			...
			Assert.assertEquals(title, "Dziękujemy za twoją subskrypcję");*/
	...
	public void Yourfamily_health() throws Exception
	{
		...
		try {
			Sync.waitElementPresent("xpath", "//a[@title='Braun Leitfäden']");
			//Common.scrollToElementAndClick("xpath", "//a[@href='/faqs/']");
			Common.javascriptclickElement("xpath" , "//a[@title='Braun Leitfäden']");

			Thread.sleep(300);

			String s=Common.getText("xpath", "//a[contains(text(), 'Braun Leitfäden')]");
			System.out.println(s +" navigated successfully");
			Assert.assertEquals(s, "Braun Leitfäden");
	...
	public void POHeaderThermometer() throws Exception
	{
		...
		try {
			...
			String title=Common.findElement("xpath", "//div[contains(text(), 'Monitorowanie temperatury, któremu możesz zaufać')]").getText();
			title=("Monitorowanie temperatury, któremu możesz zaufać");
	...
	public void NorwayHeaderThermometer() throws Exception
	{
		...
		try {
			...
			/*String title=Common.findElement("xpath", "//div[contains(text(), 'Temperaturmåling du kan stole på')]").getText();
			title=("Temperaturmåling du kan stole på");*/
	...
	public void TurkeyHeaderThermometer() throws Exception
	{
		...
		try {
			...
			/*String title=Common.findElement("xpath", "//div[contains(text(), 'Güvenebileceğiniz ateş ölçümü')]").getText();
			title=("Güvenebileceğiniz ateş ölçümü");*/
	...
	public void TurkeyHeaderBlodpreasure() throws Exception
	{
		...
		try {
			...
			/*String title=Common.findElement("xpath", "//div[contains(text(), 'Kalbiniz için yeşil ışık yakın')]").getText();
			title=("Kalbiniz için yeşil ışık yakın");*/
	...
	public void UKSVHeaderThermometer() throws Exception
	{
		...
		try {
			...
			String title=Common.findElement("xpath", "//div[contains(text(), 'Temperaturövervakning som du kan lita på')]").getText();
			title=("Temperaturövervakning som du kan lita på");
	...
	public void POHeaderBloodPressureMonitor() throws Exception
	{
		...
		try {
			...
			String title=Common.findElement("xpath", "//div[contains(text(), 'Dostań zielone światło dla swojego serca')]").getText();
			title=("Dostań zielone światło dla swojego serca");
			Thread.sleep(3000);
			report.addPassLog(expectedResult, "Should display Blood pressure Monitor Header Page", "Blood pressure Monitor Header link page display successfully", Common.getscreenShotPathforReport("Blood pressure Monitor Header link page success"));
		}catch(Exception |Error e)
		{
	...
	public void NorwayBloodPressureMonitor() throws Exception
	{
		...
		try {
			...
			/*String title=Common.findElement("xpath", "//div[contains(text(), 'Få grønt lys for hjertet ditt')]").getText();
			title=("Få grønt lys for hjertet ditt");*/
			Thread.sleep(3000);
			report.addPassLog(expectedResult, "Should display Blood pressure Monitor Header Page", "Blood pressure Monitor Header link page display successfully", Common.getscreenShotPathforReport("Blood pressure Monitor Header link page success"));
		}catch(Exception |Error e)
		{
	...
	public void SpainHeaderBloodPressureMonitor() throws Exception
	{
		...
		try {
			...
			String title=Common.findElement("xpath", "//div[contains(text(), 'Dele luz verde a su corazón')]").getText();
			title=("Dele luz verde a su corazón");
			Thread.sleep(3000);
			report.addPassLog(expectedResult, "Should display Blood pressure Monitor Header Page", "Blood pressure Monitor Header link page display successfully", Common.getscreenShotPathforReport("Blood pressure Monitor Header link page success"));
		}catch(Exception |Error e)
		{
	...
	public void SpainnavigateYourhearthealth() throws Exception
	{
		String expectedResult="Lands on Your health page";
		try {
			Sync.waitElementPresent("xpath", "(//a[@title='La salud de su corazón'])[2]");
			Common.scrollToElementAndClick("xpath", "(//a[@title='La salud de su corazón'])[2]");

			Thread.sleep(300);

			String s=Common.getText("xpath", "//a[contains(text(), 'La salud de su corazón')]");
			System.out.println(s +" navigated successfully");
			Assert.assertEquals(s, "La salud de su corazón");
...
*/
	...
	public void TurkeyFacebook() throws Exception
	{
		...
		try {
			...
			//String title=Common.findElement("xpath", "//i[@class='fb_logo img sp_3FkyymiRwDN sx_c2e63c']").getText();
			//title=("facebook");
			/*String s=Common.getText("xpath", "(//span[contains(text(), 'Braun sağlık')])[1]");
		   	System.out.println(s);
		   	Assert.assertEquals(s, "Braun sağlı");
		   	Thread.sleep(2000);*/
		   	
		   	Common.switchToSecondTab();
		   	Thread.sleep(10000);
			if(Common.isElementDisplayed("xpath", "(//span[contains(text(), 'Braun sağlık')])[1]")) {
				String s=Common.getText("xpath", "(//span[contains(text(), 'Braun sağlık')])[1]");
			   	System.out.println(s);
			   	Assert.assertEquals(s, "Braun sağlı");
			}else {
...
//	title=("facebook");
	...
	public void GEcheckoutPage() throws Exception
	{
		...
		try {
			...
			String title=Common.findElement("xpath", "//span[contains(text(), 'Bestellübersicht')]").getText();
...
catch(Exception |Error e)
{
	...
	public void GershippingAddressDetails() throws Exception{
		...
		String s=Common.getText("xpath", "//div[contains(text(), 'Versandarten auswählen')]");
		Assert.assertEquals(s, "Versandarten auswählen");
