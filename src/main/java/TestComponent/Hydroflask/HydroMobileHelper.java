...
public class HydroMobileHelper {
...
/*	public void orderSubmit(String category) throws Exception
	...
	public void orderSubmit(String category) throws Exception
	{
	    ...
	    Sync.waitElementClickable("xpath", "//div[@class='menu-trigger js-menu-trigger']");
		Thread.sleep(4000);
		Common.mouseOverClick("xpath", "//div[@class='menu-trigger js-menu-trigger']");	
		Thread.sleep(3000);
...
//		Common.clickElement("xpath","//li[@data-tab-name='E-mail Us']");
	...
	*/	
    ...
    public void Customize_Bottle() throws Exception{
    	...
    	Sync.waitElementPresent("xpath","//div[@class='menu-trigger js-menu-trigger']");
        Thread.sleep(4000);
...
public void review_bottles(String dataSet) throws Exception{
	...
	public  HydroMobileHelper(String datafile)
	{
