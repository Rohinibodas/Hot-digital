...
//span[@class='customer-name active']
 ...
 public void ProductRegistrationLinkValidation () throws InterruptedException {
 	Thread.sleep(3000);
 	try {
 	Sync.scrollDownToView("xpath","//a[@data-menu='menu-14883']");
 	Sync.waitElementClickable(10, By.xpath("//a[@data-menu='menu-14883']"));
...
public void MyAccount() throws Exception{
    ...
    Common.findElement("xpath", "//li[contains(@class,'customer-welcome')]//li[1]/a").click();
...
public void ClickMyAccount(){
	try{
		...
		Sync.waitElementVisible("xpath", "//h1[@class='hero__title hero__title--']");
         String userName=Common.getText("xpah", "//h1[@class='hero__title hero__title--']");
	    ...
	    Common.assertionCheckwithReport(userName.contains("Hi"), "verifying my account link", "User lands on the my accountpage", "User lands on AccountPage", "Faield lo land o nmyaccount");
	}
	catch(Exception |Error e) {
		e.printStackTrace();
...
Thread.sleep(5000);
 ...
 int message=Common.findElements("xpath", "(//*[@id=\"maincontent\"]/div)[1]").size();  	 Common.assertionCheckwithReport(message>0, "verifying confrmation message ", "enter with empety data it must show error message","sucessfully display the error message", "faield to dispalyerrormessage"); 
  ...
  ExtenantReportUtils.addFailedLog("Validating My Information option", "it open the My Information Dashboard", "it faield open the My Information dashboard",Common.getscreenShot("faieldMy Information"));  
	...
	public  OxoDevHelper(String datafile)
	{
