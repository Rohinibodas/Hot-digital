...
*/
	...
	public void clickBaby_Toddler() throws Exception {
		...
		try {
			...
			Common.clickElement("xpath", "//span[text()='Toggle Nav']");
	...
	public void ProductRegistration() throws InterruptedException {
		...
		// Assert.assertTrue(Common.getCurrentURL().equals("https://oxo-stg.heledigital.com/productregistration")&&Common.getPageTitle().equals("Product
		// Registration"));
	...
	public void ContactUS() throws InterruptedException {
		...
		// clickLogo();
		try {
			// Sync.scrollDownToView("xpath","//a[contains(text(),'Contact
			// Us')]");
	...
	public void PrivacyPolicy() throws InterruptedException {
		...
		// Assert.assertTrue(Common.getCurrentURL().equals("https://oxo-stg.heledigital.com/privacy")&&Common.getPageTitle().equals("Privacy
		// Policy"));
		Common.assertionCheckwithReport(
	...
	public void TermsandConditions() throws InterruptedException {
		...
		// Assert.assertTrue(Common.getCurrentURL().equals("https://oxo-stg.heledigital.com/Terms")&&Common.getPageTitle().equals("Terms
		// and Conditions"));
		Common.assertionCheckwithReport(
	...
	public void TrackOrder() throws InterruptedException {
		...
		// Assert.assertTrue(Common.getCurrentURL().equals("https://oxo-stg.heledigital.com/sales/guest/form/")&&Common.getPageTitle().equals("Orders
		// and Returns"));
		Common.assertionCheckwithReport(
	...
	public void BetterGuarantee() throws InterruptedException {
		...
		System.out.println(Common.getPageTitle());
		System.out.println(Common.getCurrentURL());
		// Assert.assertTrue(Common.getCurrentURL().equals("https://oxo-stg.heledigital.com/guarantee")&&Common.getPageTitle().equals("The
	...
	public void GoodTipsBlog() throws InterruptedException {
		...
		System.out.println(Common.getPageTitle());
		System.out.println(Common.getCurrentURL());
		// Assert.assertTrue(Common.getCurrentURL().equals("https://oxo-stg.heledigital.com/blog/")&&Common.getPageTitle().equals("OXO
	...
	public void InventorSubmissions() throws InterruptedException {
		...
		System.out.println(Common.getPageTitle());
		System.out.println(Common.getCurrentURL());
		// Assert.assertTrue(Common.getCurrentURL().equals("https://oxo-stg.heledigital.com/inventor")&&Common.getPageTitle().equals("Inventor
		// Submission"));
		Common.assertionCheckwithReport(
	...
	public void Twitter() throws InterruptedException {
		...
		// (@oxo) • Instagram photos and videos"));
		Common.assertionCheckwithReport(
				Common.getCurrentURL().equals("https://mobile.twitter.com/OXO")
						&& Common.getPageTitle().equals("Profile / Twitter"),
	...
	public OxoMobileHelper(String datafile) {
