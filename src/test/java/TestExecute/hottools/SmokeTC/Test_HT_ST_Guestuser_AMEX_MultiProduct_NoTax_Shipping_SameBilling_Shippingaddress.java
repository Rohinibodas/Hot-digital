...
public class Test_HT_ST_Guestuser_AMEX_MultiProduct_NoTax_Shipping_SameBilling_Shippingaddress {

	String datafile = "Hottools//HottoolsTestData.xlsx";
	HottoolsHelpr Hottools = new HottoolsHelpr(datafile);

	@Test(priority = 1)
	public void GuestCheckoutwithAMEX_MultiProduct_NoTax_ShippingCreditCard() {
		try {
			...
			Hottools.Guestcheckoutpage("No_tax_address");
