package TestExecute.BraunEMEA.BraunUKNOR;
...
public class Test_ST_MONO_HeaderLinks {
		...
		public void HeaderLinks() throws Exception {
			...
			try {
				...
				BraunUK.NorwayStoreSelection();
			     ...
			     /*Blood preasure monitor and nasal aspirator are navigating to United kingdom store so not able to 
			      * write for these two metods*/
