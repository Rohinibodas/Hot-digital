...
public class Test_ST_UKSOUAF_FooterLinksValidation {
	...
	BraunEMEAHelper BraunUK=new BraunEMEAHelper(datafile);
		...
		public void FooterLinksValidation() throws Exception {
			...
			try {
				...
				/*BraunUK.SOUAFnavigateYourhealth();
				BraunUK.SOUAFnavigateYourhearthealth();
				BraunUK.SOUAFnavigateHealthMagazine();*/
