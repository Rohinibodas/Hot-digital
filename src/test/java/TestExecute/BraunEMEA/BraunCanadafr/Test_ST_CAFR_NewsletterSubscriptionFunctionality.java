...
public class Test_ST_CAFR_NewsletterSubscriptionFunctionality {
	String datafile = "BraunEMEA//BraunUKTestData.xlsx";	
	BraunEMEAHelper BraunUK=new BraunEMEAHelper(datafile);
		@Test(priority=1)
		
		public void NewsletterhFunctionality() throws Exception {

			try {
				Thread.sleep(6000);
				BraunUK.Acceptcookies();
				//BraunUK.closepopup();
				BraunUK.CanadaNewslettersubscription("Newsletter");
			}
			catch (Exception e) {
