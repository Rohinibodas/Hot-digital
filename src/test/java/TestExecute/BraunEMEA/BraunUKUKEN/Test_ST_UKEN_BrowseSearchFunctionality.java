package TestExecute.BraunEMEA.BraunUKUKEN;
...
public class Test_ST_UKEN_BrowseSearchFunctionality {
	...
	BraunEMEAHelper BraunUK=new BraunEMEAHelper(datafile);
		...
		public void BrowseSearchFunctionality() throws Exception {
			...
			try {
				...
				BraunUK.closepopup();
				BraunUK.UKENStoreSelection();
				BraunUK.UKENproductname("productName");
	...
	/*@BeforeMethod
		@Parameters({"browser"}) 
		  public void startTest() throws Exception {
			System.setProperty("configFile", "BraunEMA\\config.properties");
			  Login.signIn("chrome");
