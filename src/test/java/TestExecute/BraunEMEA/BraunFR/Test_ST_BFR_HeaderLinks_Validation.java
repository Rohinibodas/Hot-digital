...
public class Test_ST_BFR_HeaderLinks_Validation {
	...
	BraunEMEAHelper BraunUK=new BraunEMEAHelper(datafile);
		...
		public void HeaderLinks() throws Exception {
			...
			try {
				...
				/* BraunUK.FRThermometer();
				 BraunUK.FRBloodPressureMonitor();
				 BraunUK.FRNasalAspirator();*/
				 
				 BraunUK.FranceheadLinks("FRHeaderlinks");
