...
public class Test_ST_BraunIT_RegisterUserCheckoutWithInvalidCreditcard {
	String datafile = "BraunEMEA//BraunUKTestData.xlsx";	
	BraunEMEAHelper BraunUK=new BraunEMEAHelper(datafile);
		@Test(priority=1)
		
		public void RegisteredCheckoutWithInvalidCreditcard() throws Exception {
			...
			try {
				...
				BraunUK.RegistercheckoutPage();
				//BraunUK.ItalyshippingAddressDetails();
				BraunUK.ItalyAddAddress();
