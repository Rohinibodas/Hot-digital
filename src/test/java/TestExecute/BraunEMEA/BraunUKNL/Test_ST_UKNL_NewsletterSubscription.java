package TestExecute.BraunEMEA.BraunUKNL;
...
public class Test_ST_UKNL_NewsletterSubscription {
	...
	BraunEMEAHelper BraunUK=new BraunEMEAHelper(datafile);
		...
		public void NewsletterSubscription() throws Exception {
			...
			try {
				...
				//BraunUK.NLStoreSelection();
				BraunUK.NLNewslettersubscription("Newsletter");
