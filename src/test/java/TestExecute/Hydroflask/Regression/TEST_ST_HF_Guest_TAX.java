...
public class TEST_ST_HF_Guest_TAX {
    ...
    public void Guest_Tax_Validation() throws Exception {
    	try {

			String addressFile = "Hydroflask//Hydrooo.xlsx";
...
//			Hydro.searchproduct_addtocart("16 oz Tumbler");
			Hydro.searchproduct_2("20 oz wide ");
			Hydro.checkOut();
...
//			String OrderId="12345";
			...
			Hydro.writeResultstoXLSx(Website,OrderId,data.get("subtotlaValue"),data.get("shippingammountvalue"),state,Zipcode,data.get("Taxammountvalue"),data.get("ActualTotalammountvalue"),data.get("ExpectedTotalAmmountvalue"),data.get("giventaxvalue"),data.get("calculatedvalue"));
