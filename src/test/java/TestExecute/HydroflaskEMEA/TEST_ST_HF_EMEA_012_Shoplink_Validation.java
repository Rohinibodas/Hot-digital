...
public class TEST_ST_HF_EMEA_012_Shoplink_Validation {
  ...
  public void Shopping_cart_Validation() {
		try {
			 ...
			 Hydro.Shop_header_Validation();
			 Hydro.accessories_Validation();
			 Hydro.tumblers_Validation();
			 Hydro.coffee_Validation();
			 Hydro.beer_Validation();
			 Hydro.Wine_Validation();
			 Hydro.coolers_Validation();
			 Hydro.Food_Validation();
