...
public class TEST_ST_SR_030PrivacyPolicyAndTermsConditions {
	String datafile = "Stinger//StingerTestData.xlsx";	
	StingerHelper Stinger=new StingerHelper(datafile);
	
	@Test(priority=1)
	public void PrivacyPolicyAndTermsConditions() throws Exception {

		try {
			//Stinger.AgreeAndProceed();
	
			Stinger.PrivacyPolicyAndTermsConditions("PrivacyPolicy");
		}
		catch (Exception e) {
