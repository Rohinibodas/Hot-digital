...
public class TEST_ST_SR_022ValidatingGuestUserShippingAddressPage {
	String datafile = "Stinger//StingerTestData.xlsx";	
	StingerHelper Stinger=new StingerHelper(datafile);
	
	@Test(priority=1)
	public void ValidatingGuestUserShippingAddressPage() throws Exception {
		...
		try {
			...
			Stinger.ShippingFormvalidation();
