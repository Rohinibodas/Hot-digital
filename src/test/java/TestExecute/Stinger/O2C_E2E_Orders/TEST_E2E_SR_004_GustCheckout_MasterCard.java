...
public class TEST_E2E_SR_004_GustCheckout_MasterCard
 {
	String datafile = "Stinger//StingerTestData.xlsx";
	StingerHelper Stinger=new StingerHelper(datafile);
		
	@Test(priority=1)
  public void GustCheckout_MasterCard() throws Exception {
		try { 
	    ...
	    HashMap<String,String> Payment=Stinger.creditCard_payment1("PaymentDetailsMaster");	
