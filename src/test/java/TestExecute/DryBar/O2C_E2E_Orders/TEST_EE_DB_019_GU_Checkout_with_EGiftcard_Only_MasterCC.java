...
public class TEST_EE_DB_019_GU_Checkout_with_EGiftcard_Only_MasterCC {
	
	String datafile = "DryBar//DryBarTestData.xlsx";	
	DryBarHelper drybar=new DryBarHelper(datafile);
	@Test(retryAnalyzer = Utilities.RetryAnalyzer.class)
	public void Guestuser_Checkout_with_EGiftcard_only_and_MasterCC() throws Exception {

		try {
			
			String Website=drybar.URL();
			String Description ="GuestUser_Checkout_EGIFT_only_with_MasterCC_Payment";
			drybar.Accept();
