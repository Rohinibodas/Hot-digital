...
public class TEST_EE_DB_015_GU_Checkout_EGift_and_Physical_UPS_Expedited_MasterCC {
	
	String datafile = "DryBar//DryBarTestData.xlsx";	
	DryBarHelper drybar=new DryBarHelper(datafile);
	@Test(retryAnalyzer = Utilities.RetryAnalyzer.class)
	public void GuestUser_Checkout_with_EGiftcard_and_Physical_UPS_Expedited_MasterCC() throws Exception {

		try {
			
			String Website=drybar.URL();
			String Description ="GuestUser_Checkout_EGIFT_and_Physical_products_with_UPS_Expedited_Shipping_MasterCCPayment";
			drybar.Accept();
