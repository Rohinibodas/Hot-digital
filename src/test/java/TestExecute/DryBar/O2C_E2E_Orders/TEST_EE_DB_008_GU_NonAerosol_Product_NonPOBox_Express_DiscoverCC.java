...
public class TEST_EE_DB_008_GU_NonAerosol_Product_NonPOBox_Express_DiscoverCC {
	String datafile = "DryBar//DryBarTestData.xlsx";	
	DryBarHelper drybar=new DryBarHelper(datafile);
		
	@Test(retryAnalyzer = Utilities.RetryAnalyzer.class)
  public void GuestUser_Checkout_Non_Aerosol_product_NonPO_Box_Express_DiscoverCC() throws Exception {
		
		
		try {
			
		String Website=drybar.URL();
		String Description ="GuestUser_Checkout_Non_Aerosol_product_with_NonPO_Box_Address_USPS_Express_Shipping_DiscoverCCPayment";
		drybar.Accept();
