...
public class TEST_EE_DB_017_GU_Checkout_with_EGiftcard_Only_VisaCC {
	
	String datafile = "DryBar//DryBarTestData.xlsx";	
	DryBarHelper drybar=new DryBarHelper(datafile);
	@Test(retryAnalyzer = Utilities.RetryAnalyzer.class)
	public void Guestuser_Checkout_with_EGiftcard_only_and_VisaCC() throws Exception {

		try {
			
			String Website=drybar.URL();
			String Description ="GuestUser_Checkout_EGIFT_only_with_VisaCC_Payment";
			drybar.Accept();
