...
public class TEST_EE_DB_014_GU_Checkout_EGift_and_Physical_Prod_UPS_Standard_DiscoverCC {
	
	String datafile = "DryBar//DryBarTestData.xlsx";	
	DryBarHelper drybar=new DryBarHelper(datafile);
	@Test(retryAnalyzer = Utilities.RetryAnalyzer.class)
	public void GuestUser_Checkout_with_EGiftcard_and_Physical_UPS_Standard_DiscoverCC() throws Exception {

		try {
			
			String Website=drybar.URL();
			String Description ="GuestUser_Checkout_EGIFT_and_Physical_products_with_UPS_Standard_Shipping_DiscoverCCPayment";
			drybar.Accept();
