...
public class TEST_EE_DB_009_GU_NonAero_Product_NonPOBox_Alaska_Expedited_MasterCC {
	String datafile = "DryBar//DryBarTestData.xlsx";	
	DryBarHelper drybar=new DryBarHelper(datafile);
		
	@Test(retryAnalyzer = Utilities.RetryAnalyzer.class)
  public void GuestUser_Checkout_Non_Aerosol_product_with_Non_PO_Box_Alaska_Expedited_MasterCC() throws Exception {
		
		
		try {
			
		String Website=drybar.URL();
		String Description ="GuestUser_Checkout_Non_Aerosol_product_with_NonPO_Box_Alaska_Address_USPS_Expedited_Shipping_MasterCCPayment";
		drybar.Accept();
