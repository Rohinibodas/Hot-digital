...
public class TEST_EE_DB_020_GU_Checkout_with_EGiftcard_Only_AmexCC {
	
	String datafile = "DryBar//DryBarTestData.xlsx";	
	DryBarHelper drybar=new DryBarHelper(datafile);
	@Test(retryAnalyzer = Utilities.RetryAnalyzer.class)
	public void Guestuser_Checkout_with_EGiftcard_only_and_AmexCC() throws Exception {

		try {
			
			String Website=drybar.URL();
			String Description ="GuestUser_Checkout_EGIFT_only_with_AmexCC_Payment";
			drybar.Accept();
