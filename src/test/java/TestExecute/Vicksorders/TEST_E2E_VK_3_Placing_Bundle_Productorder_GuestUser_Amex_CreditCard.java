...
public class TEST_E2E_VK_3_Placing_Bundle_Productorder_GuestUser_Amex_CreditCard {
	String datafile = "Vicks//VicksTestData.xlsx";	
	VicksHelper vicks = new VicksHelper(datafile);
	@Test(retryAnalyzer = Utilities.RetryAnalyzer.class)
	
	public void Placing_Bundle_Productorder_GuestUser_Amex_CreditCard() throws Throwable {

		try {
		
		  
		    String Website=vicks.URL();
		    String Description ="Placing_Bundle_Productorder_GuestUser_Amex_CreditCard";
