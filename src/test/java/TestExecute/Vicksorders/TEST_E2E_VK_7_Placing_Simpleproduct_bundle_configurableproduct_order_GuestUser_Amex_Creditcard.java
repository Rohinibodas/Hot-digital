...
public class TEST_E2E_VK_7_Placing_Simpleproduct_bundle_configurableproduct_order_GuestUser_Amex_Creditcard {
	String datafile = "Vicks//VicksTestData.xlsx";	
	VicksHelper vicks = new VicksHelper(datafile);
	@Test(retryAnalyzer = Utilities.RetryAnalyzer.class)
	
	public void Placing_Simpleproduct_bundle_configurableproduct_order_GuestUser_Amex_Creditcard() throws Throwable {

		try {
		
		  
		    String Website=vicks.URL();
		    String Description ="Placing_Simpleproduct_bundle_configurableproduct_order_GuestUser_Amex_Creditcard";
			...
			HashMap<String,String>paymentdetriles=vicks.paymentdetriles("AMEXPaymentDetails");
