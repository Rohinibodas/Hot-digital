...
public class TEST_E2E_FBZ_007_RegisterUser_Checkout_Master
 {
	String datafile = "Febreze//FebrezeTestData.xlsx";
	FebrezeHelper febreze = new FebrezeHelper(datafile);

	@Test(priority = 1)
  public void RegisterUser_Checkout_Master() throws Exception {
		try { 
	   ...
	   // HashMap<String,String> Shipping=febreze.guestShipingAddress("Address");
	    ...
	    HashMap<String,String> Payment=febreze.AddPaymentdetails1("PaymentDetailsMaster");	
