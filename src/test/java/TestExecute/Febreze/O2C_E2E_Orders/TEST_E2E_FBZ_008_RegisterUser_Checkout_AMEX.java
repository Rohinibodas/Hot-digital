...
public class TEST_E2E_FBZ_008_RegisterUser_Checkout_AMEX
 {
	String datafile = "Febreze//FebrezeTestData.xlsx";
	FebrezeHelper febreze = new FebrezeHelper(datafile);

	@Test(priority = 1)
  public void RegisterUser_Checkout_AMEX() throws Exception {
		try { 
	   ...
	   // HashMap<String,String> Shipping=febreze.guestShipingAddress("Address");
	    ...
	    HashMap<String,String> Payment=febreze.AddPaymentdetails1("PaymentDetailsAEMX");	
