package TestExecute.BraunEMEAProduction.BraunPOLP;
...
public class Test_ST_POLAND_HeaderLinks {
			...
			public void HeaderLinks() throws Exception {
				...
				try {
					...
					//BraunUK.closepopup();
					//BraunUK.StoreSelection("Poland");
				   /* BraunUK.POHeaderThermometer(); 
				    BraunUK.POHeaderBloodPressureMonitor();
				    BraunUK.PONasalAspirator();*/
				    
				    BraunUK.PolandheadLinks("PolandHeaderlinks");
