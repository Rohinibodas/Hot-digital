package TestExecute.BraunEMEAProduction.BraunCanadaEN;
...
public class Test_ST_FooterLinks {
	...
	public void Footerlinks() throws Exception {
		...
		try {
		    ...
		    BraunUK.CanadaENNavigateYourhealth("LinkText");
		    //BraunUK.CanadaENNavigateYourHearthealth("LinkText");
