...
public class Test_ST_ATDEP_HeaderLinksValidation {
			...
			public void HeaderLinks() throws Exception {
				...
				try {
				    ...
				    /*BraunUK.ATDEHeaderThermometer(); 
				    BraunUK.ATDEHeaderBloodPressureMonitor();
				    BraunUK.ATDENasalAspirator();*/
				    BraunUK.ATDEheadLinks("Austriaheaderlinks");
