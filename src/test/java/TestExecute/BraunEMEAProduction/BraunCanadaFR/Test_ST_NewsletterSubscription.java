package TestExecute.BraunEMEAProduction.BraunCanadaFR;
...
public class Test_ST_NewsletterSubscription {
	...
	public void Newslettersubscription() throws Exception {
		...
		try {
	        ...
	        BraunUK.CanadaFRNewslettersubscription("CanadaFRNewsletter");
