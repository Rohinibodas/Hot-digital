...
public class Test_ST_GuestUserCheckwith_InvalidCreditcard {
	...
	@Test(priority=1)
	public void GuestUserCheckoutwithInvalidCreditcart() throws Exception {
		...
		try {
			...
			BraunUK.GEInvalidCreditcardPayment("InvalidCreditCard");
