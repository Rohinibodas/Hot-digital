...
public class  TEST_ST_OXO_010_Registered_Checkout_Mastercard_MultiProduct_NoTax_Shipping_Diferent_BaS{
	String datafile = "oxo//OxoTestData.xlsx";
	OxoHelper oxo = new OxoHelper(datafile);

	@Test(priority = 1)

	public void TEST_ST_OXO_010_Registered_Checkout_Mastercard_MultiProduct_NoTax_Shipping_Diferent_BaS() throws Exception {
