...
public class  TEST_ST_OXO_008_Guest_Checkout_Master_MultiProduct_NoTax_Shipping_Same_BaS{
	String datafile = "oxo//OxoTestData.xlsx";
	OxoHelper oxo = new OxoHelper(datafile);

	@Test(priority = 1)

	public void TEST_ST_OXO_008_Guest_Checkout_Master_MultiProduct_NoTax_Shipping_Same_BaS() throws Exception {
