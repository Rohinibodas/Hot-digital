...
public class  TEST_ST_OXO_011_Guest_Checkout_AMEX_MultiProduct_NoTax_Shipping_Same_BaS{
	String datafile = "oxo//OxoTestData.xlsx";
	OxoHelper oxo = new OxoHelper(datafile);

	@Test(priority = 1)

	public void TEST_ST_OXO_011_Guest_Checkout_AMEX_MultiProduct_NoTax_Shipping_Same_BaS() throws Exception {
