...
public class Test_HT_RD_003_Validate_CMSPages {
	...
	public void cmspages(){
		try{
			...
			Redesign_Hottools.validateAboutUsLink();
			Redesign_Hottools.BecomeanInfluencer();
			Redesign_Hottools.productRegistration("ProductRegistration");
			Redesign_Hottools.validateWarrantyFAQs();
			//Redesign_Hottools.validateNavigateContactUs("ContactUs");
			Redesign_Hottools.validateOrderStatus();
			Redesign_Hottools.validateReturnsandRefund();
