...
public class Test_HT_RD_050_RegisterUser_Communication_preferences_subscription {
  ...
  public void Change_Email_for_Registereduser() throws Exception {
		try{
			...
			Redesign_Hottools.Accept();
			 //Redesign_Hottools.Aggree_and_proceed();
			  ...
			  Redesign_Hottools.Subscribe_To_Communication_preferences();
