...
public class Test_HT_RD_015_OutofStock_Product {
	...
	public void validationOfAccountInformation(){
		try{
			...
			Redesign_Hottools.outofstock_productname();
			Redesign_Hottools.Verify_OutofStockPDP("RetailCustomerAccountDetails");
