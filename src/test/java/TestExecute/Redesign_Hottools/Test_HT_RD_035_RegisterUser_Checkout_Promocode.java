...
public class Test_HT_RD_035_RegisterUser_Checkout_Promocode {
  ...
  public void RegUser_Checkout_Promocode() throws Exception {
		try{
			...
			Redesign_Hottools.NewsletterPopUp();
			  ...
			  Redesign_Hottools.increaseProductsQuantity("5");
