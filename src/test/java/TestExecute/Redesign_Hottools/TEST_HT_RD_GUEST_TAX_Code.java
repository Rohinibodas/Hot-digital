...
public class TEST_HT_RD_GUEST_TAX_Code {
  ...
  public void GUEST_TAX_Code() throws Exception {
		try{
			...
			String addressFile = "Redesign_Hottools//DryBarTaxAddress.xlsx";
			Redesign_Hottools.prepareTaxData("Redesign_HottoolsTaxDetails.xlsx");
			...
			Redesign_Hottools.addDeliveryAddress("ShippingAddress",streetAddress,City,Zipcode,state);
		   ...
		   // Redesign_Hottools.creditCard_payment("CCVisa");
            ...
            Redesign_Hottools.writeResultstoXLSx(Website,data.get("subtotlaValue"),data.get("shippingammountvalue"),state,Zipcode,data.get("Taxammountvalue"),data.get("ActualTotalammountvalue"),data.get("ExpectedTotalAmmountvalue"),data.get("giventaxvalue"),data.get("calculatedvalue"));
