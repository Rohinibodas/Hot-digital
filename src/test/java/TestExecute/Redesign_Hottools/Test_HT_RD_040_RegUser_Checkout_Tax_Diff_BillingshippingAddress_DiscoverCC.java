...
public class Test_HT_RD_040_RegUser_Checkout_Tax_Diff_BillingshippingAddress_DiscoverCC {
  ...
  public void Master_Tax_Promocode_Diff_BillShip() throws Exception {
		try{
			...
			Redesign_Hottools.NewsletterPopUp();
             ...
             // Redesign_Hottools.increaseProductQuantity("5");
			 ...
			 // Redesign_Hottools.couponCodeHT("promocode");
			  //Redesign_Hottools.couponCode("couponCode2");
