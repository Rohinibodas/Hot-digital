...
public class Test_HT_RD_046_GuestUser_CheckOut_NoTax_MultipleProducts_Diff_BillingandShippingAddress {
  ...
  public void GU_Amex_Tax_Multiprod_Diff_Billship() throws Exception {
		try{
             ...
             Redesign_Hottools.Verify_PDP();
			  ...
			  Redesign_Hottools.guestShippingAddress("NoTaxShippingAddress");
