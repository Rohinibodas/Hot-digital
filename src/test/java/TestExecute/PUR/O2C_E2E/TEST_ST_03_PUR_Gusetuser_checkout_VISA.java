...
public class TEST_ST_03_PUR_Gusetuser_checkout_VISA {
		
		String datafile = "PUR//PUR_TestData.xlsx";	
		PurHelper PUR=new PurHelper(datafile);
		
		@Test(priority=1)
		public void Gusetuser_checkout_VISA(){
			...
			try{
				...
				String Description ="TEST_ST_03_PUR_Gusetuser_checkout_VISA";
			//	PUR.singin("CustomerAccountdetails");
				...
				PUR.Addtobag();
                PUR.checkoutPage();
    			HashMap<String,String> Shipping=PUR.gus_Shipingdetails("Address");
