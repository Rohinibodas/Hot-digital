...
public class TEST_ST_02_PUR_RegisteruserPromocodecheckout {
		...
		public void RegisteruserPromocodecheckout(){
			...
			try{
				...
				String Description ="TEST_ST_PUR_RigesteruserPromocodecheckout";
				...
				PUR.Addtobag();
                PUR.checkoutPage();
    			HashMap<String,String> Shipping=PUR.Reg_Shipingdetails("Address");
