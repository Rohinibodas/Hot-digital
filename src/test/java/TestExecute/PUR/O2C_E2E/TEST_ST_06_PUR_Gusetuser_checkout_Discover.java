...
public class TEST_ST_06_PUR_Gusetuser_checkout_Discover {
		
		String datafile = "PUR//PUR_TestData.xlsx";	
		PurHelper PUR=new PurHelper(datafile);
		
		@Test(priority=1)
		public void Gusetuser_checkout_Discover(){
			...
			try{
				...
				String Description ="TEST_ST_06_PUR_Gusetuser_checkout_Discover";
				...
				PUR.Addtobag();
                PUR.checkoutPage();
    			HashMap<String,String> Shipping=PUR.gus3_Shipingdetails("Address");
    			
    			PUR.click_Next();
				//PUR.GuestUserApplyPromocode("promocode");
    			HashMap<String,String> data=PUR.OrderSummaryValidation();
				HashMap<String,String> Payment=PUR.creditCard_payment("DiscoverDetails");
