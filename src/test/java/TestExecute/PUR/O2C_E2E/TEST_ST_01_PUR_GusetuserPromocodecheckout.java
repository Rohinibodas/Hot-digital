...
public class TEST_ST_01_PUR_GusetuserPromocodecheckout {
		
		String datafile = "PUR//PUR_TestData.xlsx";	
		PurHelper PUR=new PurHelper(datafile);
		
		@Test(priority=1)
		public void GusetuserPromocodecheckout(){
			...
			try{
				...
				String Description ="TEST_ST_01_PUR_GusetuserPromocodecheckout";
				...
				PUR.Addtobag();
                PUR.checkoutPage();
    			HashMap<String,String> Shipping=PUR.Shipingdetails("Address");
    		//	HashMap<String,String> data=PUR.OrderSummaryValidation();
				//PUR.shipping_Address("Address");
    			PUR.click_Next();
    			HashMap<String,String> data=PUR.OrderSummaryValidation();
				//PUR.GuestUserApplyPromocode("promocode");
				HashMap<String,String> Payment=PUR.creditCard_payment("PaymentDetails");
