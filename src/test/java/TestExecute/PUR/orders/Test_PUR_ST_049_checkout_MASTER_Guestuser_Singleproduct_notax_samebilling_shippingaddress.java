...
public class Test_PUR_ST_049_checkout_MASTER_Guestuser_Singleproduct_notax_samebilling_shippingaddress {

	String datafile = "PUR//PUR_TestData.xlsx";
	PurHelper PUR = new PurHelper(datafile);

	@Test(priority = 1)
	public void GuestusercheckoutMASTER_single_notaxsameShippingBillA() {
