...
public class TEST_ST_HW_042_GuestUser_Checkout_VisaCCTax_Dis_1prod_SameBill_ship {
	String datafile = "Honeywell\\HoneywellTestData.xlsx";	
	Honeywellhelper honeyWell=new Honeywellhelper(datafile);
	@Test(retryAnalyzer = Utilities.RetryAnalyzer.class)
	
	
	public void GuestUser_Checkout_VisaCC_Tax_with_Promotion_and_Single_products_with_Same_Billing_and_shipping_Address() throws Exception {
